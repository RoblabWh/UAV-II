...
def ransacPlane(segment, localNormals):
    ...
    for i in range(k):
        ...
        if len(consensusSet) > len(bestConsensus):
            #print("new: ", len(consensusSet), len(bestConsensus), normal, dPlane)
...
def labelPlanes(pointcloudPath, outputPathWithFileBasename):
    ...
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Eight/d-1295838871.208572-2758725525pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Eight/r-1295838871.223909-2759973104undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Seven/d-1295836456.718805-1139633710pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Seven/r-1295836456.724393-1140030896undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Six/d-1295148616.605279-1131612824pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Six/r-1295148616.642831-1134159635undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Fifth/d-1294890235.349177-3030778186pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Fifth/r-1294890235.374729-3033322919undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/FourthNoPlaneInData/d-1316653649.123522-1139603952pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/FourthNoPlaneInData/r-1316653649.152430-1142125575undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Third/d-1316653585.885734-1640487523pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Third/r-1316653585.912940-1642547484undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Second/d-1316653587.489233-1736590963pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Second/r-1316653587.512883-1738561284undist.ppm')
    #pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Nine/d-1315418961.223898-3111310978pclKinect.npy')
    #img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/Nine/r-1315418961.252373-3112699315undist.ppm')
    # pcl = np.load(r'/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/First/d-1316653580.471513-1316138413pclKinect.npy')
    # img = imread('/home/gas/Dokumente/PlaneSegmentation/PlanesFromPCL/First/r-1316653580.484909-1316500621undist.ppm')
    ...
    binCurvImg = binaCurvImg(curvImg, threshold=0.008)
    ...
    if len(filteredSegments) != 0:
        N = 3
        neighborhoodWndX = np.arange(-N, N+2)
        neighborhoodWndY = np.copy(neighborhoodWndX)
        neighborhoodWndXX, neighborhoodWndYY = np.meshgrid(neighborhoodWndX, neighborhoodWndY)
        numberNeighborsTotalNew = len(neighborhoodWndX)**2 - 1

        zzExpanded = np.copy(zzOrig)
            ...
            for p in segment:
                ...
                for nx in neighborhoodWndX:
                    for ny in neighborhoodWndY:
                        ...
                        intersection = plane_intersection(np.asarray((0.0, 0.0, 0.0), np.float), zzOrig[p[0], p[1]], *(planes[i]))
                        #print(intersection)
                        if len(intersection) != 1:
                            zzExpanded[p[0], p[1]] = intersection
                            planesBin[p[0], p[1]] = 255
                        else:
                            zzExpanded[p[0], p[1]] = [0,0,0]

        #zzSave = np.reshape(zzExpanded, (zzExpanded.shape[0] * zzExpanded.shape[1], 3))
        np.save(outputPathWithFileBasename + '_planesPCL', zzExpanded)
        cv2.imwrite(outputPathWithFileBasename + 'planesBinMask.png', planesBin)
