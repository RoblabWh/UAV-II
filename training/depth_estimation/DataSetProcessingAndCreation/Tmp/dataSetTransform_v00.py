...
import time
import PlaneLabeling_b as PlaneLabeling
...
if __name__=='__main__':
    ...
    #print('number of transforms: {}\ntotal time elapsed: {}\navg time/transform {}'.format(len(syncDataPaths), third_time - second_time, (third_time-second_time)/len(syncDataPaths)))
    '''
