...
#40_40flur_model.h5
parser.add_argument('--model', default='/media/gas/Samsung_T5/NYU_DenseDepth/models/1579792070-n3332-e40-bs3-lr0.0001-densedepth_nyu/weights.22-0.19.hdf5', type=str, help='Trained Keras model file.') # nyu.h5
...
class Window(QtWidgets.QWidget):
    ...
    def loadVideoFile(self):
        self.capture = cv2.VideoCapture('/media/gas/1tbssd/Videos/tello_szenario.avi')
        self.updateInput.emit()
    ...
    def loadImageFile(self):
        self.capture = None
        filename = QtWidgets.QFileDialog.getOpenFileName(None, 'Select image', '', self.tr('Image files (*.jpg *.png *.ppm)'))[0]
