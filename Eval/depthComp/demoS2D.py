...
class Window(QtWidgets.QWidget):
    ...
    def loadDepthImageFile(self):
        ...
        loadedDepth[loadedDepth > 3] = 0
        loadedDepthCropped = loadedDepth
        print()
        print('{} {}'.format(np.min(loadedDepth), np.max(loadedDepth)))
        print()
...
class GLWidget(QtOpenGL.QGLWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.loadedDepth = np.load('0102.npy')
        self.imgSci = imageio.imread('0102.png')
    ...
    def worldCoords(self, width, height):
        hfov_degrees, vfov_degrees = 57, 43#43
