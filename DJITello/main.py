...
def main():
    ...
    while True:
        try:
            #time.sleep(1)
            frame = cv2.resize(drone.read(), (101, 101))/255.0
            ...
            propability = left_propability / 2 - right_propability
            ...
            rc_drone_command = "rc 0 " + str(int(control_data_propability[0][1] * 40)) + " 0 " + str(int(propability * 50))
